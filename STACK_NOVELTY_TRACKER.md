...
| G2_gpu_idle_streak | 20260408T2022Z | 0 idle streaks (all 8 pods 85-100%); 3 NIGHT_MODE LEGAL_TTT sweep still in flight (B=LR_HALF 25min, H=LN_SCALE_1337 34min, J=LR2X 47min); 2STEPS queued for E | 0 streaks >5s util<80% | PASS | 0 |
