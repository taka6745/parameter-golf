...
| STACK_MDL_LEGAL_TTT_GATED | - | mdl_compressible_first + LEGAL_TTT + gated_attention (3-way world-novel COMBINATION, never tested together) | **yes (world-novel combination)** | **C90 1521Z queued** | hypothesis: L02 anti-curriculum (1.4093) + champion stack (1.3711) compose to 1.36-1.37 region; n=2 seeds 42/1337 in queue for Pod E | pending | E | 20260408T1521Z |
...
| G2_gpu_idle_streak | 20260408T1522Z | 0 idle streaks (all 8 pods 100%); 8 unique experiments | 0 streaks >5s util<80% | PASS | 0 |
