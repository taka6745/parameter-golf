...
| G2_gpu_idle_streak | 20260408T1957Z | 0 idle streaks (all 8 pods 78-100%); 3 NIGHT_MODE LEGAL_TTT tests in flight (F=5STEPS_1337 30min, H=LN_SCALE_1337 9min, J=LR2X 22min); B=SP6 placeholder (LR_HALF queued) | 0 streaks >5s util<80% | PASS | 0 |
