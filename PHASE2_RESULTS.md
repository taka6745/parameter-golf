...
| **E25_wide (NUM_LAYERS=6 + MLP_MULT=3 + TRAIN_SEQ_LEN=1024)** | 1×RTX 3090 24GB | 108.4s train + ~7 min wallclock | **152 train** (wallclock cap) | **713 ms/step** (+2% vs E24) | ~18M params | pre-quant **2.99545** / quant **3.25776** (gap 0.26) | tbd | **🏆🏆 4.11× vs E1 (FASTEST!)** | 🔥🔥 **ABSOLUTE SPEED CHAMPION.** 6 layers + mlp=3 + seq=1024 = fastest config tested. 152 steps in 108s. Pre-quant 2.995 (still sub-3.0). Quant gap widest (0.26) — quant eval hurts more with smaller seq_len. For pure speed E25, for quality E24. | 20260409T1738Z |
