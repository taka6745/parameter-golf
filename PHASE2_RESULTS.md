...
| **E18_triple (NUM_LAYERS=8 + MLP_MULT=3 + TRAIN_SEQ_LEN=1024)** | 1×RTX 3090 24GB | 108.4s train + eval + quant (still running) | **123 train** (wallclock cap) | **881 ms/step** (**+10% vs E17, +40% vs E13**) | 223K tok/s effective (+12% vs E17) | pre-quant **3.12824** | tbd | **🔥🔥🔥 3.33× vs E1 (PAST 3×!)** | 🎯 Combining all three compute cuts: layers=8, mlp=3, seq=1024. **23.1M params** (-36% vs E6). 123 steps in 108s. New speed record. Quality cost ~0.065 BPB vs E17 (3.128 vs 3.065). | 20260409T1619Z+ |
